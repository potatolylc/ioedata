...
public class DeviceController {
	...
	@ResponseBody
	public String deviceRegistration(@PathVariable("deviceId") String deviceId, @PathVariable("deviceIp") String deviceIp, @PathVariable("deviceIpPort") int deviceIpPort, @PathVariable("devicePassword") String devicePassword){
	...
	@ResponseBody
	public String deviceAuthentication(@PathVariable("deviceId") String deviceId,  @PathVariable("deviceIp") String deviceIp, @PathVariable("deviceIpPort") int deviceIpPort, @PathVariable("devicePassword") String devicePassword){
