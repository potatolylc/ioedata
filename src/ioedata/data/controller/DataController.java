...
public class DataController {
	...
	@ResponseBody
	public String retrieveDataListByDate(@PathVariable("deviceId") String deviceId, @PathVariable("sensorType") String sensorType, @PathVariable("startDate") String startDate, @PathVariable("endDate") String endDate){
	...
	@ResponseBody
	public String retrieveDataListByTime(@PathVariable("deviceId") String deviceId, @PathVariable("sensorType") String sensorType, @PathVariable("startDate") String startDate, @PathVariable("startTime") String startTime, @PathVariable("endDate") String endDate, @PathVariable("endTime") String endTime){
	...
	private JSONObject createJsonObjForDataValue(DataValue dataVal){
		JSONObject json = new JSONObject();
	...
	private JSONArray createJsonArrayForDataValueList(List<DataValue> dataList){
		JSONArray jsonArr = new JSONArray();
